...
public class conta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        icon_pagar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                icon_pagarMouseClicked(evt);
            }
        });
    ...
    private void icon_pagarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_icon_pagarMouseClicked
        // TODO add your handling code here:
        if(!checkJFrameAberto){
            JFrame tela_formPgmt = new conta_formaPagamento();
            tela_formPgmt.setVisible(true);
            
            checkJFrameAberto = true;
        }
    }//GEN-LAST:event_icon_pagarMouseClicked
