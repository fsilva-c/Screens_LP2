 ...
 * @author filipe
 */
public class Cardapio_Comida extends javax.swing.JFrame {
    int xMouse, yMouse;

    /**
     * Creates new form Cardapio_Comida
     */
    public Cardapio_Comida() {
        initComponents();
    ...
    private void initComponents() {
        ...
        label_comida.setFont(new java.awt.Font("Ubuntu Light", 0, 24)); // NOI18N
                    ...
                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                        .addComponent(label_comida, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(Food comida : comidas.CarregarDados()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cardapio_Comida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cardapio_Comida().setVisible(true);
            }
        });
    }
