 ...
 */
public class Pesquisa_Bonus extends javax.swing.JFrame {
    private int xMouse, yMouse;
    
    /**
     * Creates new form Pesquisa
     */
    public Pesquisa_Bonus() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabela_bonus = new javax.swing.JTable();
        ...
        icon_bonus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Screens/icons/icons8-presente-96.png"))); // NOI18N

        label_realLogin.setFont(new java.awt.Font("Ubuntu Light", 1, 24)); // NOI18N
        label_realLogin.setForeground(new java.awt.Color(204, 204, 204));
        label_realLogin.setText("Bonus");

        tabela_bonus.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "CPF", "Valor", "Data", "Situacao"
            }
        ));
        jScrollPane1.setViewportView(tabela_bonus);
    ...
    public void Carregar_tabela(){
        ...
        for(Client cliente: bonus.getAllBonus()){
            ...
            modelo.addRow(new Object[]{
                cliente.getCpf(),
                cliente.getBonus().getValue(),
                cliente.getBonus().getDate(),
                cliente.getBonus().getStrSituacao()
            });
        }
        texto_total.setText(Float.toString(total));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pesquisa_Bonus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pesquisa_Bonus().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabela_bonus;
